...
const Main = () => {
  ...
  return (
    <main className="bg-base-100 min-h-[65vh] md:min-h-screen bg-cover relative flex items-end" style={{backgroundImage:`url(${background})`}}>
        {/* Hero Section Content */}
        <div className="absolute w-full h-full flex flex-col items-center justify-center leading-10 md:leading-[0.8] z-[7] md:bottom-14" >
            <h2 className="text-[1.5rem] md:text-[4rem] font-extrabold text-center uppercase">full-stack developer</h2>
            <h1 className="text-[2.5rem] md:text-[8rem] font-extrabold text-center uppercase ">frank ramirez</h1>
        </div>
        {/* Parallax Background */}
        <div className="parallax" style={{gridArea:"stack"}}>
          ...
          <div className="w-full h-full flex items-end">
            <div className='w-full bg-base-100' style={{height: `${scrollY/10}vh`}}></div>
          </div>
